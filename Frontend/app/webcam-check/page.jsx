...
function WebcamCheckContent() {
  ...
  // Pulls dynamic IDs from the URL query params
  const subtopicId = searchParams.get('subtopicId');
  const studentId = searchParams.get('studentId') || localStorage.getItem('student_id');
  ...
  const handleStartStudy = () => {
    ...
    router.push(`/study/${subtopicId}/${studentId}`); // ← fixed: real template literal
  };
